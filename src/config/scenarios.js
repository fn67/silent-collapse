...
export const ACTION_PHRASES = [
  ...
  { text: "Leadership is participation.", audio: "/audio/action/leadership.mp3" },
  { text: "Togetherness resists decay.", audio: "/audio/action/togetherness.mp3" },
  { text: "Innovation requires courage.", audio: "/audio/action/innovation.mp3" },
